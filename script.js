...
const newweather = "frío";

const result1 = (newweather === "soleado") 
  ? "Me vestiré con un vestido" 
  : (newweather === "lluvioso") 
    ? "Me vestiré con impermeable" 
    : (newweather === "frío") 
      ? "Me vestiré con abrigo" 
      : "Me vestiré con pantalón";
...
function saludar(nombre) {
  return `Hola, me llamo ${nombre} Que tal?`;
}

console.log(saludar("Robert"));
console.log(saludar("Pablo"));
console.log(saludar("Prisha"));
...
console.log(calcularAreaRectangulo(5,30 ));   
console.log(calcularAreaRectangulo(8, 15));   
console.log(calcularAreaRectangulo(16, 30));   
console.log(calcularAreaRectangulo(9, 13));    
